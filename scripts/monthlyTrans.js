...
async function getData() {
    const response = await fetch('./data/monthly_transaction.json'); // Ganti dengan path yang sesuai jika perlu
...
async function createChart() {
    ...
    // Ekstrak data untuk labels bulan dan nilai penjualan dari data JSON
    ...
    const ctx = document.getElementById('barChartVertical2').getContext('2d');
